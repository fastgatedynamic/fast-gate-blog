...
function App() {
  ...
  return (
    <Router>
      <div className="App">
   <header className="news-portal-header bg-white shadow-md">g-white shadow-md">g-white shadow-md">g-white shadow-md">bg-white shadow-md"> bg-white shadow-md"> bg-white shadow-md">
